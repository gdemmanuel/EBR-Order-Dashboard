...
export default function OrderDetailModal({ order, onClose, onUpdateFollowUp, onEdit }: OrderDetailModalProps) {
  ...
  const handleSendText = () => {
    ...
    // Use window.location.href to open the default messaging app
          ...
          <div className="bg-brand-tan/40 border border-brand-tan p-4 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-end">
              <div>
                ...
                <select id="followUpStatus" value={order.followUpStatus} onChange={handleStatusChange} className="rounded-md border-gray-300 shadow-sm focus:border-brand-orange focus:ring-brand-orange">
