                                            ...
                                            <div key={idx} className="bg-white p-2 rounded shadow-sm text-sm">
                                                ...
                                                <div className="mb-2">
                                                    <input 
                                                        ...
                                                        className={`font-medium block w-full border-b border-gray-300 hover:border-brand-orange focus:border-brand-orange focus:ring-0 px-1 py-1 text-sm bg-transparent transition-colors ${!flavor.visible ? 'text-gray-400 line-through' : 'text-brand-brown'}`}
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <div className="w-20 relative">
                                                        ...
                                                        <input type="number" step="0.01" placeholder="Extra" value={flavor.surcharge || ''} onChange={(e) => updateFlavorSurcharge(idx, e.target.value)} className="w-full text-xs border-gray-200 rounded pl-6 focus:ring-brand-orange focus:border-brand-orange"/>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    ...
                                    <div className="flex gap-2 mb-2">
                                        ...
                                        <input type="number" step="0.01" placeholder="Price" value={newTier.type === 'mini' ? newTier.price : ''} onChange={(e) => setNewTier({...newTier, type: 'mini', price: e.target.value})} className="w-24 text-sm rounded border-gray-300"/>
                                    ...
                                    <ul className="text-sm space-y-1">
                                        {pricing.mini.tiers?.map(t => (
                                            <li key={t.minQuantity} className="flex justify-between bg-white p-2 rounded border border-gray-200">
                                                <span>{t.minQuantity}+ items: <strong>${t.price.toFixed(2)}</strong> ea</span>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    ...
                                    <div className="flex gap-2 mb-2">
                                        ...
                                        <input type="number" step="0.01" placeholder="Price" value={newTier.type === 'full' ? newTier.price : ''} onChange={(e) => setNewTier({...newTier, type: 'full', price: e.target.value})} className="w-24 text-sm rounded border-gray-300"/>
                                        <button onClick={addTier} className="text-xs bg-brand-brown text-white px-2 rounded">Add</button>
                                    </div>
                                    <ul className="text-sm space-y-1">
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="0.01" value={newEmployee.hourlyWage} onChange={e => setNewEmployee({...newEmployee, hourlyWage: parseFloat(e.target.value)})} className="w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-orange focus:border-brand-orange text-sm"/>
                                        </div>
                                            ...
                                            {employees.map(emp => (
                                                <tr key={emp.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        $<input type="number" step="0.01" value={emp.hourlyWage} onChange={e => updateEmployee(emp.id, 'hourlyWage', parseFloat(e.target.value))} className="w-16 border-none bg-transparent p-0 focus:ring-0"/>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="0.01" value={laborWage} onChange={(e) => setLaborWage(parseFloat(e.target.value)||0)} className="w-full rounded border-gray-300"/>
